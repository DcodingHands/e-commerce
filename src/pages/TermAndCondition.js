...
const TermAndCondition = () => {
  return (
    <>
      ...
      <BredCrumb title="Term & Condition" />
      <section className=" py-4">
        <div className="container">
          <div className="row">
            <div class="col-lg-8 mx-auto mb-5 mb-lg-0">
              <h1 class="mb-4 text-center">Our Terms & Conditions</h1>
              <div class="content">
                <h4 id="responsibility-of-contributors">Shipping</h4>
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                  Purus, donec nunc eros, ullamcorper id feugiat quisque aliquam
                  sagittis. Sem turpis sed viverra massa gravida pharetra. Non
                  dui dolor potenti eu dignissim fusce. Ultrices amet, in
                  curabitur a arcu a lectus morbi id. Iaculis erat sagittis in
                  tortor cursus. Molestie urna eu tortor, erat scelerisque eget.
                  Nunc hendrerit sed interdum lacus. Lorem quis viverra sed
                </p>
                <p>
                ...
                <h4 id="gathering-of-personal-information">Refund</h4>
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                  Purus, donec nunc eros, ullamcorper id feugiat quisque aliquam
                  sagittis. Sem turpis sed viverra massa gravida pharetra. Non
                ...
                <p>
                  ...
                  sed interdum lacus. Lorem quis viverra sed Lorem ipsum dolor
                  sit amet, consectetur adipiscing elit. Purus, donec nunc eros,
                ...
                <ol>
                  ...
                  <li>
                    Any Update come in The technology Customer will get
